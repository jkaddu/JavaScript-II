...
// Problem 1
// Lets get all the runners with emails ending in .edu, group them as studnets
let students = [];

students = runners.filter(runner => {
...
// Problem 2
// if they gave a dontaion higher than 100 lets give them a gift, find those runners
let gifts = [];

gifts = runners.filter(runner => {
...
// Problem 3
// lets get a list of all the company names 
